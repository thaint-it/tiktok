      ...
      children: [
        ...
        Row(
          children: [
            MaterialButton(
              onPressed: () {
                controller.value =
                    _getZoomInfo(widget.width, widget.height, size, 1.0);
              },
              child: Text("Reset"),
            ),
            MaterialButton(
              onPressed: () {
                ...
                var zoom = w / h;
                controller.value =
                    _getZoomInfo(widget.width, widget.height, size, zoom);
              },
            ...
            MaterialButton(
              onPressed: () {
                controller.value =
                    _getZoomInfo(widget.width, widget.height, size, 2.0);
              },
              child: Text("Zoom 2x"),
            ),
            MaterialButton(
              onPressed: () {
                controller.value =
                    _getZoomInfo(widget.width, widget.height, size, 4.0);
              },
              child: Text("Zoom 4x"),
            ),
          ],
        ...
        MaterialButton(
          onPressed: () {
            ...
            final orginalImageBytes = widget.image.readAsBytesSync();
            img.Image originalImage = img.decodeImage(orginalImageBytes)!;
